    ...
    it('should return festivals with right fields', function() {
      ...
      return chai
        ...
        .then(function(festival) {
          ...
          JSON.stringify(resFestival.date).should.equal(
            JSON.stringify(festival.date)
          );
    ...
    it('should add a new festival', function() {
      ...
      return chai
        ...
        .then(function(res) {
          ...
          JSON.stringify(res.body.date).should.equal(
            JSON.stringify(newFestival.date)
          );
        ...
        .then(function(festival) {
          ...
          JSON.stringify(festival.date).should.equal(
            JSON.stringify(newFestival.date)
          );
